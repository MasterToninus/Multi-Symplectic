...
\begin{abstract}
In this talk we detail the construction of the covariant phase space starting from multisymplectic framework of geometric classic field theories following essentially the paper written by forger romero. 
...
\begin{figure}
\centering
  \includestandalone[mode=buildnew]{sigma}
  %\caption{.}
\end{figure}
...
\begin{figure}
  \centering
    \includestandalone[mode=buildnew]{fieldJacobi}
  %\caption{.}
\end{figure}
